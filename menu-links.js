(() => {
  ...
  const injectThemeStyles = () => {
    ...
    style.textContent = [
      ...
      '.study-now{display:grid;gap:3px;min-width:154px;padding:14px 16px;border:1px solid #c99a49;border-radius:5px;background:#fff8ea;color:#17243a;text-align:center;box-shadow:0 8px 18px rgba(8,21,38,.08);}',
