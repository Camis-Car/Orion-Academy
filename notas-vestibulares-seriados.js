...
(() => {
  ...
  window.NOTAS_VESTIBULARES_SERIADOS = {
    ...
    processos: [
      ...
      { uf: 'MG', estado: 'Minas Gerais', nome: 'PASES/UFV', instituicao: 'Universidade Federal de Viçosa', local: 'Viçosa, Florestal e Rio Paranaíba, MG', fonte: 'UFV — Programa de Avaliação Seriada para Ingresso', url: 'https://www2.dti.ufv.br/noticias/scripts/exibeNoticiaMulti.php?codNot=45910' },
      ...
      { uf: 'PR', estado: 'Paraná', nome: 'PAC/Unicentro', instituicao: 'Universidade Estadual do Centro-Oeste', local: 'Guarapuava, Irati e unidades da Unicentro, PR', fonte: 'Unicentro — Programa de Avaliação Continuada', url: 'https://www3.unicentro.br/blog/2026/07/15/pac-2026-da-unicentro-esta-com-inscricoes-abertas-ate-20-de-julho/' },
